...
/**
 * קומפוננטת מחוון טעינה - מותאמת למולטי-פלטפורם
 * 
 * @param {string} message - הודעת טעינה לתצוגה
 * @returns {JSX.Element} - קומפוננטת React למחוון טעינה
 */
const LoadingIndicator = ({ message = 'מחשב תאריך עברי...' }) => {
  return (
